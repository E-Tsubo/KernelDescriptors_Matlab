...
[tmp, minvalue, maxvalue] = scaletrain(rgbdfea_joint, 'linear');
rgbdfea = [];
rgbdfea = rgbdfea_joint;
save -v7.3 rgbdfea_joint rgbdfea rgbdclabel rgbdilabel rgbdvlabel minvalue maxvalue;
