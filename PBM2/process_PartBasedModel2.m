...
%% PBM %%%%%%%%%%%%
part_idx = varargin{2};
partmodel = varargin{1}.partmodel{part_idx};
num_model = varargin{1}.featurenum(part_idx);

if num_model == 1 
    input = varargin{1}.input{part_idx};
    mode = input;
else
    flag_rgb = 0;
    flag_dep = 0;
    ...
    if flag_rgb == 1 && flag_dep == 1
        mode = 'com';
    elseif flag_rgb == 1 && flag_dep == 0
        mode = 'comrgb';
    elseif flag_rb == 0 && flag_dep == 1
        mode = 'comdep';
    end
